                            ...
                            <div className="row footer-top-inner-w3ls">
                                ...
                                <div className="align1" >
                                    <div className="footer-w3pvt" >
                                        <h4 className="mb-3 w3pvt_title" style={{fontFamily:"Raleway",color:"#ececec"}}>Quick Links </h4>
                                        <hr/>
                                        <ul className="list-info-w3pvt last-w3ls-contact mt-lg-4">
                                            <li>
                                            <Link to ="/about" style={{fontFamily:"Raleway",color:"#ececec",fontSize:"1.2em"}}>About Us</Link>
            
                                            </li>
                                            <li className="my-2">
                                            <Link to ="/visitus" style={{fontFamily:"Raleway",color:"#ececec",fontSize:"1.2em"}}>Visit Us</Link>
            
                                            </li>
                                            <li className="my-2">
                                            <Link to ="/products" style={{fontFamily:"Raleway",color:"#ececec",fontSize:"1.2em"}}>Products</Link>
